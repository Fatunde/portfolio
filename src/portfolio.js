...
export const experience = [
  {
    ...
    company: "Taxaide Group",
    //	companylogo: googlelogo,
    date: "October 2022 – Present",
    desc: "I worked as Full-stack developer creating tech solutions to problems, i was able to impact and positively influence the team with my skills",
    /*descBullets: [
...
export const projects = [
  {
    name: "Taxtech Assessment Portal",
    desc: "Taxtech assessment portal is an application that helps recruiter access their potential candidates. I rendered the client side UI and also implemented the client side functionalities",
    link: "https://reap-dev.taxit.com.ng/",
  },
  {
    name: "TFleet",
    desc: "Tfleet is a logistic system, which i play a role of building significant part of the server side and also all the functionalities on the client side",
    link: "https://tfleet.io/",
  },
  {
  ...
  {
    name: "Strive Human resouces ATS",
    desc: "Built the server side, render designs pages, and created every functionalities in the client side in the application tracking system",
    link: "https://ats.strivehumanresources.com/",
  },
  {
